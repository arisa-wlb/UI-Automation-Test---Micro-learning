...
test('Tax Invoice 3 รายการ - ลบ 1 รายการ แล้ว Submit สำเร็จ', async ({page}) => {
  ...
  await test.step('ตรวจสอบ Grand Total เท่ากันกับ 19,260.00', async () => {
